...
@interface PDTestMessage : NSObject
@end

@implementation PDTestMessage
@end
...
- (void)testFields {
    PDMessageDescriptor *message = [[PDMessageDescriptor alloc] initWithClass:[PDTestMessage class] fields:@[
...
- (void)testDiscriminator {
    ...
    PDMessageDescriptor *message = [[PDMessageDescriptor alloc] initWithClass:[PDTestMessage class]
...
- (void)testSubtypes {
    ...
    PDMessageDescriptor *base = [[PDMessageDescriptor alloc]
            initWithClass:[PDTestMessage class]
                     base:nil
       discriminatorValue:0
         subtypeSuppliers:@[
                 ...
                 ^PDMessageDescriptor *() {
                   ...
                   fields:nil];
    subtype0 = [[PDMessageDescriptor alloc] initWithClass:[PDTestMessage class]
                                                     base:nil
                                       discriminatorValue:1
                                         subtypeSuppliers:nil
                                                   fields:nil];
    subtype1 = [[PDMessageDescriptor alloc] initWithClass:[PDTestMessage class]
                                                     base:nil
